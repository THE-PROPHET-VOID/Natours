...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // This line of code below help in placing the current logged in user so that we can restrict or do other stuff besed on that information.
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  // 1) Get user from the collcection
